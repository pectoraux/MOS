 ...
 * Authority: Integration contracts (spec/implementation-contract.md §1).
 *
...
export const integrationsModule = {
  name: 'integrations',
  authority: 'Integration contracts',
} as const;

export type IntegrationsModule = typeof integrationsModule;
