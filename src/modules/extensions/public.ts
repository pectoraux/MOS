 ...
 * Authority: Extension registry/invocation contract (spec/implementation-contract.md §1).
 *
...
export const extensionsModule = {
  name: 'extensions',
  authority: 'Extension registry/invocation contract',
} as const;

export type ExtensionsModule = typeof extensionsModule;
